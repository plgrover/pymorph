...
I am getting things to work in terms of the hydrodynamics but the morphodynamics
do not look correct. Holding here and going on to version 5.
...
def main_EULER():
    ...
    qbed_line, = ax4.plot(x,sed_model.get_Qbed(),label='Qbed')
    ...
    try:
        while t < t_max:
            ...
            if cntr == plotting_update_interval:
                ...
                max_qbed = max(sed_model.get_Qbed())
