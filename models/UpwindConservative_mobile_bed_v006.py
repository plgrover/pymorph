...
'''
This one is based on the Exner Analytical Equation in Cowles 2013
A Block Structured Adaptive Mesh Refinement Solver for Morphodynamic Modelling
...
def main_EULER():
    ...
    for i in range(len(x)):
        ...
        Zbed[i] =A0 + A1*math.sin(math.pi*x[i]/lam)- S*(dx*float(i))
    ...
    try:
        while t < t_max:
            ...
            Z[number_nodes-1] = Zout
            A[number_nodes-1] = width * (Z[number_nodes-1] - Zbed[number_nodes-1])
